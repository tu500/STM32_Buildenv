...
typedef void (*publish_callback) (char const *topic, uint16_t topic_length,
    void const *payload, uint16_t payload_length, bool retained);
...
uint8_t mqtt_register_callback(mqtt_callback_config_t const *callbacks);
